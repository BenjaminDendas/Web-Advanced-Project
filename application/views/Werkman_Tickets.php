...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table').DataTable({
            ...
            ajax: {
                url: "<?php echo site_url('WerkmanTickets/ajax_list')?>",
                type: "POST"
            },
    ...
    function edit_ticket(id)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('WerkmanTickets/ajax_edit/')?>/" + id,
            type: "GET",
            dataType: "JSON",
    ...
    function save()
    {
        ...
        var url;
        if(save_method == 'add') {
            url = "<?php echo site_url('WerkmanTickets/ajax_add')?>";
        } else {
            url = "<?php echo site_url('WerkmanTickets/ajax_update')?>/";
        }
    ...
    function delete_ticket(id)
    {
        if(confirm('Bent u zeker dat u dit ticket wilt verwijderen?'))
        {
            ...
            $.ajax({
                url : "<?php echo site_url('WerkmanTickets/ajax_delete')?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
