...
class Tickets_model extends CI_Model {
    ...
    var $column = array('TK_Onderwerp', 'TK_Beschrijving', 'TK_Status',
        'TK_Prioriteit', 'TK_GebruikerID', 'TK_Categorie', 'TK_SluitDatum'); //set column field database for order and search
    /**
    ...
    function get_datatables($id)
    {
        ...
        $this->db->where('TK_GebruikerID',$id);
        $query = $this->db->get();
        return $query->result();
    }

    /**
     * Aantal tickets gefilterd op ID.
     *
     * Geeft het aantal tickets terug van één bepaalde gebruiker.
     *
     * @param $id
     * @return mixed
     */
